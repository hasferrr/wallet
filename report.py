...
def report():
    ...
    # Query data account_name and its amount, and store to list ---> [('Income', 10000.0), ('Gifts', 10000.0)]
    ...
    con.close()
    return render_template("report.html", total_income_f=total_income_f, total_expense_f=total_expense_f, diff=diff, income_percent=income_percent, expense_percent=expense_percent, income_list_amount_f=income_list_amount_f, expense_list_amount_f=expense_list_amount_f)
